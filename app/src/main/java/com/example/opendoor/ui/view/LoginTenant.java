...
public class LoginTenant extends AppCompatActivity {
            ...
            auth.signInWithEmailAndPassword(email, password)
                    .addOnCompleteListener(this, task -> {
                        if (task.isSuccessful()) {
                            ...
                            Intent intent = new Intent(LoginTenant.this, MainActivity.class);
                            startActivity(intent);
                            finish();
                        } else {
                            Toast.makeText(LoginTenant.this, "Authentication failed", Toast.LENGTH_SHORT).show();
                        }
                    });
        }
    }
    ...
    private void resetPassword() {
        ...
        auth.sendPasswordResetEmail(email)
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        Toast.makeText(LoginTenant.this, "Password reset email sent", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(LoginTenant.this, "Failed to send reset email", Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    private void navigateToSignUp() {
        ...
        Intent intent = new Intent(LoginTenant.this, SignUpTenant.class);
        startActivity(intent);
    }
}
