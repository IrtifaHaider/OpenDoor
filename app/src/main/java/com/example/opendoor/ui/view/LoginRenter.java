            ...
            auth.signInWithEmailAndPassword(email, password)
                    .addOnCompleteListener(this, task -> {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(LoginRenter.this, "Authentication failed", Toast.LENGTH_SHORT).show();
                        }
                    });
        }
    }
    ...
    private void resetPassword() {
        ...
        auth.sendPasswordResetEmail(email)
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        Toast.makeText(LoginRenter.this, "Password reset email sent", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(LoginRenter.this, "Failed to send reset email", Toast.LENGTH_SHORT).show();
                    }
                });
    }
